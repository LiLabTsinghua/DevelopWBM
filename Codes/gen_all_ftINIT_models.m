%% Human2 ftINIT-Hart2015
prepData = prepHumanModelForftINIT(ihuman, false, 'C:\Users\DELL\OneDrive - tju.edu.cn\ÎÄµµ\GitHub\Human-GEM\data\metabolicTasks\metabolicTasks_Essential.txt', 'C:\Users\DELL\OneDrive - tju.edu.cn\ÎÄµµ\GitHub\Human-GEM\model\reactions.tsv');

gtex_data = readtable('Hart2015_RNAseq.txt');
[~, n] = size(gtex_data);
numSamp = n-1;
...
preData = prepHuman_1_ModelForftINIT(model, false, 'D:\Human_issue_check\Human1.3_ftINIT\metabolicTasks_essential.txt');
...
essentialTasksFilePath = '/home/jiahao/Recon3D_ftINIT/Recon3D_essential_tasks.txt';
taskStruct = parseTaskList(essentialTasksFilePath);
...
prepDataHumanGEM = prepINITModel(model1, taskStruct, spontRxnNames, convertGenes, customRxnsToIgnore, extComp);
