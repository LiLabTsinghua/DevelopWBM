...
def Data_plot(x,y):
    ...
    # plt.savefig("../../results/Figures/Support_Fig_7a_male_BMR.pdf", dpi=400, bbox_inches = 'tight')
    plt.show()

def main():

    df_corr = pd.read_csv('../../results/BMR/Result_AdultMale_BMR.tsv', sep = '\t')
